...
2. **Clone this repository.** - `git clone https://github.com/milangupta511/react-redux-hmr` or [download the zip]
3. **Make sure you're in the directory you just created.** - `cd react-redux-hmr`
